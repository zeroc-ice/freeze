...
void
FreezeScript::ObjectWriter::_iceWrite(Ice::OutputStream* out) const
{
    out->startValue(0);
...
void
FreezeScript::ObjectWriter::_iceRead(Ice::InputStream*)
{
    assert(false);
}
...
void
FreezeScript::ObjectReader::_iceWrite(Ice::OutputStream*) const
{
    assert(false);
}

void
FreezeScript::ObjectReader::_iceRead(Ice::InputStream* in)
{
